...
class CheckpointHandler:
    def __init__(self, coordinator_args: CoordinatorArguments, collab_optimizer_args: CollaborativeOptimizerArguments,
                 averager_args: AveragerArguments, dht: src.DHT):
        ...
        self.collaborative_optimizer = src.CollaborativeOptimizer(
            opt=opt, dht=dht, prefix=experiment_prefix,
            compression_type=src.utils.CompressionType.Value(collab_optimizer_args.compression),
...
if __name__ == '__main__':
    ...
    dht = src.DHT(start=True, listen_on=coordinator_args.dht_listen_on,
